...
public class calculatorOfCostTravelAndFlights {
	
	//MAIN
	public static void main(String[] args) {
		Scanner lector = new Scanner(System.in);
		String travelAccompanied = welcome();
		double totalPassengerToPay = 0;
		
		while (!travelAccompanied.equalsIgnoreCase("alone") && !travelAccompanied.equalsIgnoreCase("accompanied")) {
			System.out.println("You must select between (alone) or (accompanied).");
			travelAccompanied=lector.nextLine();
		}
			//ALONE
			if (travelAccompanied.equalsIgnoreCase("alone")) {
			...
			if (travelAccompanied.equalsIgnoreCase("accompanied")) {
				for (int i=1; i<4; i++) {
					if (i>1) {
						System.out.println(" ");
	...
	// 1. Welcome | METHOD String
			/**
			*
			* This method will welcome the user and it will ask if he/she is traveling alone or accompanied
			*
			* @return travelAccompanied
			*
			*/
			public static String welcome() {
				Scanner lector = new Scanner(System.in);
				System.out.println("Welcome to the Flight Calculator");
				System.out.println("You are traveling alone or accompanied?");
				String travelAccompanied=lector.nextLine();
			return travelAccompanied;
			}
